...
public class HttpServer {
	...
	public static void main(String[] args) throws IOException {
		String folder = "C:\\Users\\Sushil's pc\\OneDrive\\Skrivbord\\ID1212\\l2\\";
		...
		while (true) {
			...
			if ((requestedDocument.length() == 1) && (requestedDocument.indexOf("/") == 0))
				requestedDocument = folder + "index.html"; // Lägg till en slash här
			else
			...
			response.println("Set-Cookie: clientId=1; expires=Wednesday,31-Dec-23 21:00:00 GMT"); // Remove date to make
																									// it a
																									// session-cookie
